...
export declare class ApexExecutionOverlayResultCommand extends BaseCommand {
    private readonly commandName;
    private readonly heapdumpKey;
    constructor(heapdumpKey: string);
    getCommandUrl(): string;
    getRequest(): string | undefined;
}
//# sourceMappingURL=apexExecutionOverlayResultCommand.d.ts.map